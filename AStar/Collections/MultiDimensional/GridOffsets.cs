...
namespace AStar.Collections.MultiDimensional
{
    public static class GridOffsets
    {
        ...
        public static List<(sbyte row, sbyte column)> GetOffsets(bool withDiagonals = false)
        {
            return withDiagonals 
                ? CardinalDirectionOffsets.Concat(DiagonalsOffsets).ToList() 
                : CardinalDirectionOffsets.ToList();
        }
